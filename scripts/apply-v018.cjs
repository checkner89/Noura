...
// Center the add control relative to the *actual navigation bar width* instead
// of relying on percentage positioning on the 64pt button itself. The wrapper
// is pointer-events transparent, so the surrounding tab buttons stay tappable.
...
replaceOnce(
  "  bottomNavIconBoxActive: { backgroundColor: 'rgba(113,85,143,0.10)' },",
